...
public class ChamberScreen extends AbstractContainerScreen<ChamberMenu> {
    ...
    private static final Identifier ARROW_TEXTURE =
            Identifier.fromNamespaceAndPath(Essentia.MODID,"textures/gui/essenceextractor/progress.png");

    public ChamberScreen(ChamberMenu menu, Inventory inventory, Component title) {
    ...
    private void renderProgressArrow(GuiGraphicsExtractor guiGraphics, int x, int y) {
        if(menu.isCrafting()) {
            guiGraphics.blit(RenderPipelines.GUI_TEXTURED, ARROW_TEXTURE,x + 45, y + 35, 0, 0,
