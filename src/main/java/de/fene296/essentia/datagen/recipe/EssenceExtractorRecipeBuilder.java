...
public class EssenceExtractorRecipeBuilder implements RecipeBuilder {
    ...
    private EssenceExtractorRecipeBuilder(RecipeCategory category, Ingredient resource, int resourceCount,
    ...
    public static EssenceExtractorRecipeBuilder extractRecipe(RecipeCategory category,
        ...
        return new EssenceExtractorRecipeBuilder(category, resource, resourceCount, dust, dustCount, crystal, crystalCount,
